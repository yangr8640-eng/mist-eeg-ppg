...
**v0.2.0 为稳定发布版，实机功能验收通过。** 2026-09-20，项目使用者确认 QX-EEG-4 脑环、PPG 指夹和 GT-M601 蓝牙温度套件均已实际试用，三路联调及一次完整实验运行正常。验收依据为使用者实测反馈，详见 [实机验收记录与复验指南](docs/HARDWARE_ACCEPTANCE.md)。本次验收不包含测量精度校准或毫秒级硬件同步验证。
